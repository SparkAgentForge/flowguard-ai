...
import { auditDecisionLabels, humanDecisionLabels, videoKindLabels, workOrderStatusLabels } from '../lib/presentation'
...
export function ReportsPage() {
  ...
  useEffect(() => {
    Promise.all([listWorkOrders(), listReports()]).then(([allOrders, archived]) => {
      ...
      setReports(archived)
    }).catch((cause) => setError(cause instanceof Error ? cause.message : '无法加载可归档工作单。'))
  }, [])
